...
class AMPLoader:
    ...
    def __init__(
        ...
        # if torch.isnan(self.all_trajectories_full).any():
    ...
    def get_full_frame_at_time_batch(self, traj_idxs, times):
        ...
        rot_blend = utils.quaternion_slerp_safe(all_frame_rot_starts, all_frame_rot_ends, blend)
    ...
    def feed_forward_generator(self, num_mini_batch, mini_batch_size):
        ...
        for _ in range(num_mini_batch):
            if self.preload_transitions:
                ...
                s = torch.cat([ self.preloaded_s[idxs,AMPLoader.JOINT_POSE_START_IDX:AMPLoader.JOINT_POSE_START_IDX+3],
                                self.preloaded_s[idxs,AMPLoader.JOINT_POSE_START_IDX+4:AMPLoader.JOINT_POSE_START_IDX+7],
                                self.preloaded_s[idxs,AMPLoader.JOINT_POSE_START_IDX+8:AMPLoader.JOINT_POSE_START_IDX+11],
                                self.preloaded_s[idxs,AMPLoader.JOINT_POSE_START_IDX+12:AMPLoader.JOINT_POSE_START_IDX+15],
                                self.preloaded_s[idxs,AMPLoader.JOINT_POSE_START_IDX+16:AMPLoader.JOINT_POSE_END_IDX],
                                self.preloaded_s[idxs,AMPLoader.JOINT_POSE_END_IDX:AMPLoader.JOINT_VEL_END_IDX]],dim=1)
                s_next = torch.cat([self.preloaded_s_next[idxs,AMPLoader.JOINT_POSE_START_IDX:AMPLoader.JOINT_POSE_START_IDX+3],
                                    self.preloaded_s_next[idxs,AMPLoader.JOINT_POSE_START_IDX+4:AMPLoader.JOINT_POSE_START_IDX+7],
                                    self.preloaded_s_next[idxs,AMPLoader.JOINT_POSE_START_IDX+8:AMPLoader.JOINT_POSE_START_IDX+11],
                                    self.preloaded_s_next[idxs,AMPLoader.JOINT_POSE_START_IDX+12:AMPLoader.JOINT_POSE_START_IDX+15],
                                    self.preloaded_s_next[idxs,AMPLoader.JOINT_POSE_START_IDX+16:AMPLoader.JOINT_POSE_END_IDX],
                                    self.preloaded_s_next[idxs,AMPLoader.JOINT_POSE_END_IDX:AMPLoader.JOINT_VEL_END_IDX]],dim=1)
                ...
                #                 self.preloaded_s[idxs,AMPLoader.JOINT_POSE_START_IDX+12:AMPLoader.JOINT_POSE_START_IDX+15],
                #                 self.preloaded_s[idxs,AMPLoader.JOINT_POSE_START_IDX+16:AMPLoader.JOINT_POSE_END_IDX],
                #                 self.preloaded_s[idxs,AMPLoader.JOINT_POSE_END_IDX:AMPLoader.JOINT_VEL_START_IDX],
                #                 self.preloaded_s[idxs,AMPLoader.JOINT_VEL_START_IDX:AMPLoader.JOINT_VEL_START_IDX+3],
                #                 self.preloaded_s[idxs,AMPLoader.JOINT_VEL_START_IDX+4:AMPLoader.JOINT_VEL_START_IDX+7],
                #                 self.preloaded_s[idxs,AMPLoader.JOINT_VEL_START_IDX+8:AMPLoader.JOINT_VEL_START_IDX+11],
                #                 self.preloaded_s[idxs,AMPLoader.JOINT_VEL_START_IDX+12:AMPLoader.JOINT_VEL_START_IDX+15],
                #                 self.preloaded_s[idxs,AMPLoader.JOINT_VEL_START_IDX+16:AMPLoader.JOINT_VEL_END_IDX]],dim=1)
                # s_next = torch.cat([self.preloaded_s_next[idxs,AMPLoader.JOINT_POSE_START_IDX:AMPLoader.JOINT_POSE_START_IDX+3],
                #                     self.preloaded_s_next[idxs,AMPLoader.JOINT_POSE_START_IDX+4:AMPLoader.JOINT_POSE_START_IDX+7],
                #                     self.preloaded_s_next[idxs,AMPLoader.JOINT_POSE_START_IDX+8:AMPLoader.JOINT_POSE_START_IDX+11],
                #                     self.preloaded_s_next[idxs,AMPLoader.JOINT_POSE_START_IDX+12:AMPLoader.JOINT_POSE_START_IDX+15],
                #                     self.preloaded_s_next[idxs,AMPLoader.JOINT_POSE_START_IDX+16:AMPLoader.JOINT_POSE_END_IDX],
                #                     self.preloaded_s_next[idxs,AMPLoader.JOINT_POSE_END_IDX:AMPLoader.JOINT_VEL_START_IDX],
                #                     self.preloaded_s_next[idxs,AMPLoader.JOINT_VEL_START_IDX:AMPLoader.JOINT_VEL_START_IDX+3],
                #                     self.preloaded_s_next[idxs,AMPLoader.JOINT_VEL_START_IDX+4:AMPLoader.JOINT_VEL_START_IDX+7],
                #                     self.preloaded_s_next[idxs,AMPLoader.JOINT_VEL_START_IDX+8:AMPLoader.JOINT_VEL_START_IDX+11],
                #                     self.preloaded_s_next[idxs,AMPLoader.JOINT_VEL_START_IDX+12:AMPLoader.JOINT_VEL_START_IDX+15],
                #                     self.preloaded_s_next[idxs,AMPLoader.JOINT_VEL_START_IDX+16:AMPLoader.JOINT_VEL_END_IDX]],dim=1)
    ...
    def observation_dim(self):
        ...
        dim = self.trajectories[0].shape[1] + 1
        return dim - 4
